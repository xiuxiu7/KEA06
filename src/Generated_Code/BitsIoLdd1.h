...
#define BitsIoLdd1_PRPH_BASE_ADDRESS  0x400FF000U
...
#define BitsIoLdd1_MODULE_BASE_ADDRESS GPIOA_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd1_PORTCONTROL_BASE_ADDRESS PORT_BASE_PTR /*!< Name of macro used as the base address */
#define BitsIoLdd1_PORT_MASK 0x0C00U   /*!< Mask of the allocated pin from the port */
...
#define BitsIoLdd1_PIN_ALLOC_0_MASK 0x0400 /*!< Mask of the first allocated pin from the port */
#define BitsIoLdd1_PIN_ALLOC_0_INDEX 10U /*!< The index of the first allocated pin from the port */
